    ...
    <form id="form" class="container m-4" method="POST">
        <div class="columns is-multiline">
            <div class="column is-full">
                <div class="field">
                    <label class="label" for="nama">NAMA PEGAWAI:<span class="required">*</span></label>
                    <div class="control">
                        <input class="input" id="nama" type="text" placeholder="Nama" name="NAMA PEGAWAI" required oninvalid="setCustomValidity('Sila isi bahagian ini')" oninput="setCustomValidity('')" />
                    </div>
                </div>
            </div>
            <div class="column is-full">
                <div class="field">
                    <label class="label" for="unit">UNIT/ BAHAGIAN:<span class="required">*</span></label>
                    <div class="control">
                        <input class="input" id="unit" type="text" placeholder="UNIT/ BAHAGIAN" name="UNIT/ BAHAGIAN" required oninvalid="setCustomValidity('Sila isi bahagian ini')" oninput="setCustomValidity('')" />
                    </div>
                </div>
            </div>
            <div class="column is-full">
                <div class="field">
                    <label class="label" for="tujuan">TUJUAN:<span class="required">*</span></label>
                    <div class="control">
                        <input class="input" id="tujuan" type="text" placeholder="" name="TUJUAN" required oninvalid="setCustomValidity('Sila isi bahagian ini')" oninput="setCustomValidity('')" />
                    </div>
                </div>
            </div>
            <div class="column is-full">
                <div class="field">
                    <label class="label" for="tarikh">TARIKH:<span class="required">*</span></label>
                    <div class="control">
                        <input class="input" id="tarikh" type="date" name="TARIKH" required oninvalid="setCustomValidity('Sila isi bahagian ini')" oninput="setCustomValidity('')" />
                    </div>
                </div>
            </div>
            <div class="column is-full">
